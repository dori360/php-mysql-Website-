...
<html>
    <head>
        <title><?php echo stripslashes($pageDetails["page_title"]); ?> - <?php echo SITE_NAME; ?> - www.Tikpub.com</title>
        <link rel="icon" href="http://Tikpub.com" src="/images/t.ico" type="image/x-icon" />
